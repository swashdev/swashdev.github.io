...
cybernetic augmentations, mutations, _&c_.  Roguelikes are typically very
...
window.  My solution to this was to allow the game to support multiple methods
of display depending on the user's preferences.
...
supporting a number of play styles but excelling at any one core mechaic.  I
wanted Swash to focus very strongly on sword combat because there's a lot of
...
far enough to fully explore this concept.
...
A later version of Crawl written in Python featured a map generator and
field-of-vision not too dissimilar to what SwashRL has now.  The name had to
be changed to avoid confusion with another classic game called
[Linley's Dungeon Crawl][Crawl], being renamed to Slumbering Dragon,
FORRNIF[^1], Spelunk!, and finally SwashRL.
